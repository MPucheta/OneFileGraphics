...
const CACHE_KEY = 'toy-car-loading-cache-key';

function ToyCarLoading() {
  ...
  const handleFileChange = async (
    ...
    if (file && file.name.endsWith('.glb')) {
      ...
      reader.onload = () => {
        (window as any).uploadedToyCarGLB = new Uint8Array(
  ...
  return (
    <>
      ...
      <div className="flex pl-[0px] px-4 py-3 border-b border-gray-800 items-center shadow-lg">
        ...
        <div className="flex items-center bg-blue-900/40 border border-blue-500/30 px-3 py-2 rounded-lg text-blue-200 text-xs h-[38px]">
          <svg
      ...
      <CanvasWithEditor
        key={loadKey}
        cacheKey={CACHE_KEY}
        codePath="toyCarLoading.sample.ts"
